...
export const metadata: Metadata = {
  title: "Contact Us | AnovasOS",
  description: "Get in touch with the AnovasOS team to talk through your home service business.",
};
        ...
        <div className="max-w-6xl mx-auto px-6 py-16 grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-white/70 text-sm md:text-base leading-relaxed max-w-lg mb-6">
              ...
              show you how AnovasOS fits your operation.
            </p>
