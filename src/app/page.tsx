      ...
      <div className="p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          <div className="rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
            ...
            <Link href="/sales" className="text-xs text-orange font-medium mt-4 inline-block hover:underline">
              View Sales Pipeline →
            </Link>
          </div>
          ...
          <div className="rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
            ...
            <Link href="/jobs" className="text-xs text-orange font-medium mt-4 inline-block hover:underline">
              View Jobs →
            </Link>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          <div className="rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
            <div className="flex items-center justify-between mb-4">
              ...
              <Link href="/risks" className="text-xs text-orange font-medium hover:underline">
                View all →
              </Link>
            </div>
